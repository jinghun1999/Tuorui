...
class ChooseVaccineInfo extends Component {
    ...
    componentDidMount() {
        ...
        _this.timer = setTimeout(
            () => {
                _this._fetchData(_this.state.value,1,false);
            }, 500
        )
    }
    ...
    _fetchData(value,page,isNext) {
        ...
        storage.getBatchData([{
            ...
            syncInBackground: false,
                ...
                if (!isNext) {
                    //http://petservice.tuoruimed.com/service/Api/ItemTypeWithBranchDefine/GetRecordCount
